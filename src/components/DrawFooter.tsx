...
export function DrawFooter({ onDraw, canPaidDraw }: DrawFooterProps) {
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 px-4 pb-8 pt-6 bg-gradient-to-t from-[#5c0000] via-[#8b0000]/90 to-transparent md:static md:bg-none md:p-0 md:mt-4">
       <div className="max-w-md mx-auto flex gap-4 md:max-w-full">
          ...
          >
             ...
             <span className="text-white/80 text-[10px] font-bold relative z-10 bg-black/10 px-2 py-0.5 rounded-full leading-tight backdrop-blur-sm">1 USDT</span>
          </button>
          ...
          >
             ...
             <span className="text-[#5c0000]/80 text-[10px] font-bold relative z-10 bg-white/20 px-2 py-0.5 rounded-full leading-tight">10 USDT</span>
          </button>
       </div>
    </div>
  );
