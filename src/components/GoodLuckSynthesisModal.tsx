...
interface GoodLuckSynthesisModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function GoodLuckSynthesisModal({ isOpen, onClose }: GoodLuckSynthesisModalProps) {
  ...
  const cards = [
    { img: careerImg, rotate: 0, x: 0, y: -100 },
                ...
                <div className="bg-[#fff9f0] rounded-xl p-6 text-center overflow-hidden relative border border-white/20">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex justify-center mb-10">
                        ...
                        >
                            <img src={luckImg} alt="好运马" className="w-full h-auto drop-shadow-lg" />
                        </motion.div>
                      </div>
